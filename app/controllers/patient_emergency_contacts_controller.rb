class PatientEmergencyContactsController < ApplicationController
  ...
  def show
   ...
   def edit
      @patient = Patient.find(params[:patient_id])
      @patient_emergency_contact = @patient.patient_emergency_contacts.find(params[:id])
   end
   ...
   def update
      ...
      respond_to do |format|
         if @patient_emergency_contact.update(patient_emergency_contact_params)
            format.html { redirect_to patient_path(@patient), notice: 'Patient emergency contact was successfully updated.' }
   ...
   def destroy
      ...
      respond_to do |format|
         format.html { redirect_to patient_path(@patient), notice: 'Patient emergency contact was successfully destroyed.' }
