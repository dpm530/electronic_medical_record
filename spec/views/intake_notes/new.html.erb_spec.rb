...
RSpec.describe "intake_notes/new", type: :view do
  before(:each) do
    assign(:intake_note, IntakeNote.new(
      :user => nil,
      :patient => nil,
      :duration => "MyString",
      :location => "MyString",
  ...
  it "renders new intake_note form" do
    render

    assert_select "form[action=?][method=?]", intake_notes_path, "post" do
