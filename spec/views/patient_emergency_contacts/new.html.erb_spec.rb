...
RSpec.describe "patient_emergency_contacts/new", type: :view do
  before(:each) do
    assign(:patient_emergency_contact, PatientEmergencyContact.new(
      :first_name => "MyString",
      :last_name => "MyString",
  ...
  it "renders new patient_emergency_contact form" do
    render

    assert_select "form[action=?][method=?]", patient_emergency_contacts_path, "post" do
